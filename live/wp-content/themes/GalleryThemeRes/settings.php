...
<tr>
  ...
  <td><input type="text" name="custom_logo_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_custom_logo_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload your logo</a> (ex: 360px wide x 150px high)</small></td>
</tr>
<tr>
  <td>Border Color:</td>
  <td><input type="text" name="border_color" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_border_color',''))); ?>" /> <small>e.g.: #27292a</small></td>
</tr>
<tr>
  <td>Facebook Link:</td>
