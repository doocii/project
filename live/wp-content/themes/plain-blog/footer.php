...
?>
	...
	<div class="copyright">
     ...
     <a target="_blank" href="http://www.navthemes.com/plain-blog-theme"><?php _e('Plain Blog Theme', 'plain-blog'); ?></a> <?php _e('By', 'plain-blog') ?> <a target="_blank" href="http://www.2zzt.com">WordPress</a>   
    </div>        
   </div>       
